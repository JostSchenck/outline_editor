...
// class SingleColumnOutlineComponentContext {
//   /// Creates a component context.
//   const SingleColumnOutlineComponentContext({
...
/// [SingleColumnOutlineLayout].
///
/// A [SingleColumnOutlineLayoutComponentViewModel] is created for every [DocumentNode]
...
/*
class SingleColumnOutlineLayoutPresenter {
  SingleColumnOutlineLayoutPresenter({
    required Document document,
    required List<ComponentBuilder> componentBuilders,
    required List<SingleColumnOutlineLayoutStylePhase> pipeline,
  })  : _document = document,
  ...
  final List<SingleColumnOutlineLayoutStylePhase> _pipeline;
  ...
  final _listeners = <SingleColumnOutlineLayoutPresenterChangeListener>{};

  void addChangeListener(
      SingleColumnOutlineLayoutPresenterChangeListener listener) {
  ...
  void updateViewModel() {
    editorLayoutLog
        .info("Calculating an updated view model for document layout.");
...
/*
class SingleColumnOutlineLayoutPresenterChangeListener {
  const SingleColumnOutlineLayoutPresenterChangeListener({
...
//   /// Produces a [SingleColumnOutlineLayoutComponentViewModel] with default styles for the given
//   /// [node], or returns `null` if this builder doesn't apply to the given node.
//   SingleColumnOutlineLayoutComponentViewModel? createViewModel(
...
//   Widget? createComponent(SingleColumnOutlineComponentContext componentContext,
//       SingleColumnOutlineLayoutComponentViewModel componentViewModel);
// }
...
/*abstract class SingleColumnOutlineLayoutStylePhase {
  void dispose() {
    _dirtyCallback = null;
  }
...
// /// View model for an entire [SingleColumnOutlineDocumentLayout].
// class SingleColumnOutlineLayoutViewModel {
//   SingleColumnOutlineLayoutViewModel({
//     this.padding = EdgeInsets.zero,
//     required List<SingleColumnOutlineLayoutComponentViewModel>
//         componentViewModels,
...
//
//   final List<SingleColumnOutlineLayoutComponentViewModel> _componentViewModels;
//   List<SingleColumnOutlineLayoutComponentViewModel> get componentViewModels =>
//       _componentViewModels;
//
//   final Map<String, SingleColumnOutlineLayoutComponentViewModel>
//       _viewModelsByNodeId;
//   SingleColumnOutlineLayoutComponentViewModel? getComponentViewModelByNodeId(
//           String nodeId) =>
...
/// [SingleColumnOutlineLayout].
abstract class SingleColumnOutlineLayoutComponentViewModel
    extends SingleColumnLayoutComponentViewModel {
  SingleColumnOutlineLayoutComponentViewModel({
  ...
  /// The indentLevel of this component in the layout. An indentLevel of 0
  /// means a root node, negative indents are not allowed.
  int indentLevel;

  // @override
  // SingleColumnOutlineLayoutComponentViewModel copy();

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SingleColumnOutlineLayoutComponentViewModel &&
