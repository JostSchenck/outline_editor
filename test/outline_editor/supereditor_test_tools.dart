...
// with only TestDocumentSelector modified
//
import 'dart:math';
...
//
// MODIFICATIONS FOR outline_editor ON
//

/// Selects a [Document] configuration when composing an [OutlineEditor]
/// widget in a test.
///
...
class TestDocumentSelector {
  ...
  TestSuperEditorConfigurator withOnlyTitleEmptyDoc() {
    return TestSuperEditorConfigurator._(
      _widgetTester,
      onlyTitleEmptyDoc(),
    );
...
//
// MODIFICATIONS FOR outline_editor OFF
//
